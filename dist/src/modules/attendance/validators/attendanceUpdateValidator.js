...
exports.attendanceUpdateValidator = [
    ...
    (0, express_validator_1.body)("status").optional().isIn(Object.values(attendanceStatus_1.AttendanceStatus)),
];
