...
exports.leaveRequestCreateValidator = void 0;
...
exports.leaveRequestCreateValidator = [
    (0, express_validator_1.body)("reason").custom(customValidators_1.default.isNotEmptyAndString),
