...
exports.createLocationDataValidator = void 0;
const express_validator_1 = require("express-validator");
const Staff_1 = require("../../staff/models/Staff");
exports.createLocationDataValidator = [
    ...
    (0, express_validator_1.body)("latitude").optional().isNumeric(),
    (0, express_validator_1.body)("longitude").optional().isNumeric(),
];
