...
const TalukService_1 = __importDefault(require("../services/TalukService"));
class TalukController extends BaseController_1.default {
    constructor() {
        super(...arguments);
        this.service = new TalukService_1.default();
        this.list = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                const { search } = req.query;
                const { filterQuery, sort } = req;
                const taluks = yield this.service.list(search, filterQuery, sort);
        ...
        this.create = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const taluk = yield this.service.create(req.body);
...
exports.default = TalukController;
